...
import com.conta_bancaria_springboot.conta_bancaria_springboot.domain.exceptions.TransferenciaParaMesmaContaException;
import com.conta_bancaria_springboot.conta_bancaria_springboot.domain.exceptions.ValoresNegativosException;
...
public abstract class Conta {
    ...
    public void sacar(BigDecimal valor){
        if (valor.compareTo(BigDecimal.ZERO) < 0){
            throw new ValoresNegativosException("saque");
        }
